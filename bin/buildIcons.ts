...
const iconsOutputDir = path.join(cwd, "src", "assets");
const typesOutputDir = path.join(cwd, "src", "generated");
...
await writeIfChanged(
  path.join(iconsOutputDir, "sprite.svg"),
  spritesheetContent
);
...
await writeIfChanged(path.join(typesOutputDir, "icons.ts"), typesContent);
